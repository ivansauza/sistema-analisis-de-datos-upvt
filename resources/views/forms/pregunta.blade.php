...
<div class="row">
	<div class="col-7">
		<div class="form-group">
			...
			{{ Form::select('rol_id', ['secretaria' => 'Secretaria', 'ptc' => 'PTC', 'director' => 'Director'], null, ['class' => 'form-control', 'required']) }}
		...
		<div class="form-group">
			...
			{{ Form::select('programa_id', ['a' => 'Ingeniería en Informática', 'b' => 'Maestría en Administración'], null, ['class' => 'form-control', 'multiple' => false, 'required']) }}
		</div>
	</div>
	<div class="col">
		<div class="form-group">
