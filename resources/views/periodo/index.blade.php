...
@section('content')
	...
	@if($programas->get()->isEmpty())
		<h6 class="text-center text-muted">
			No tiene Programas Educativos asignados.
		</h6>
	@else
		@if(!$programas->where('predeterminado', '=', 1)->first())
			<h6 class="text-center text-muted">
				Selecciona un programa educativo como predeterminado.
			</h6>
		@else
			<div class="card card-default">
				<table class="table table-hover">
					...
					<tbody>
						@foreach($programas->where('predeterminado', '=', 1)->first()->periodos as $periodo)
							<tr>
