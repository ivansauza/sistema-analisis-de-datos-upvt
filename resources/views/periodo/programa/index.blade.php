...
@section('header')
	...
	<div class="btn-toolbar mb-2 mb-md-0">
		<div class="btn-group mr-2">
			<a href="{{ route('periodos.create', ['programa_id' => Request::input('programa_id')]) }}" class="btn btn-outline-primary btn-sm">Crear Periodo</a>
...
@section('content')
	...
	<div class="card card-default">
		...
		<table class="table table-hover">
			...
			<tbody>
				@foreach($programa->periodos as $periodo)
					<tr>
