	...
	<div class="card card-default">
		<table class="table table-striped table-hover">
			...
			<tbody>
				<tr>
					<th scope="row">1</th>
					<td>Valor de la pregunta</td>

					<td>
						<div class="float-right">
							<a href="{{ route('preguntas.show', 0) }}" class="btn btn-sm btn-outline-primary mt-1">
								<i class="fas fa-eye"></i>
							</a>

							<a href="{{ route('preguntas.edit', 0) }}" class="btn btn-sm btn-outline-warning mt-1">
								<i class="fas fa-pencil-alt"></i>
							</a>

							{{ Form::open(['route' => ['preguntas.destroy', 0], 'method' => 'DELETE', 'class' => 'd-md-inline']) }}
