	...
	<div class="card card-default">
		<div class="card-header">
			...
			<div class="float-right p-0 m-0">
				...
				<a href="{{ route('procesos.show', 0) }}" class="btn btn-sm btn-primary mt-1">
					<i class="fas fa-eye"></i>
				</a>

				<a href="{{ route('procesos.edit', 0) }}" class="btn btn-sm btn-warning mt-1">
					<i class="fas fa-pencil-alt"></i>
				</a>

				{{ Form::open(['route' => ['procesos.destroy', 0], 'method' => 'DELETE', 'class' => 'd-inline']) }}
					<button type="submit" class="btn btn-danger btn-sm mt-1" onclick="! confirm('Confirmar para eliminar el elemento definiticamente.') ? event.preventDefault() : ''"><i class="fas fa-trash-alt"></i></button>
				{{ Form::close() }}
			</div>
		</div>
			...
			<div class="card card-default border-left-0 border-right-0 rounded-0 mb-3">
				<div class="card-header">
					...
					<div class="float-right p-0 m-0">
						...
						<a href="{{ route('indicadores.show', 0) }}" class="btn btn-sm btn-outline-primary mt-1">
							<i class="fas fa-eye"></i>
						</a>

						<a href="{{ route('indicadores.edit', 0) }}" class="btn btn-sm btn-outline-warning mt-1">
							<i class="fas fa-pencil-alt"></i>
						</a>
